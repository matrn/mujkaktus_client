...
def parse_info(html):
	...
	return data - with examples:
		'credit' : 101.5
		'credit_expiration' : '11.11.2019'

		'minutes' : 15.6
		'minutes_type' : 1
		
	'''
	global credit, credit_unit, credit_expire, credit_expire_unit
	global minutes, minutes_unit, minutes_type
	global sms, sms_unit, sms_type
	global mb_normal, mb_social, mb_type
	global renew_keyword, once_keyword
